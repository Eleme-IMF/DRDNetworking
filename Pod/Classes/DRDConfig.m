...
NSString * DRDDefaultSendRequestTooFastErrorString = @"Request send too fast, please try again later";
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.sendRequestTooFastErrorStr           = DRDDefaultSendRequestTooFastErrorString;
...
-(id)copyWithZone:(NSZone *)zone {
    ...
    config.sendRequestTooFastErrorStr = self.sendRequestTooFastErrorStr;
